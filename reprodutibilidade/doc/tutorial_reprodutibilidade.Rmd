...
#### map_result<i>(iNome, DADOS, REFERENCE, titulo = "Titulo", shp_mun = NULL, shp_uf  = NULL, salvar = FALSE, nome_arquivo = "map_N7.png", largura = 20, altura = 24, dpi = 300, fsize = 16)</i>
```{r, eval = TRUE,fig.width=7.2, fig.height=5}
...
```
## Scripts Extras Disponibilizados
